...
extern struct bench_operations n_mkdir_ops;
extern struct bench_operations u_mkdir_ops;
extern struct bench_operations n_mknod_ops;
extern struct bench_operations u_mknod_ops;
